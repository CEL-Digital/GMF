const heroData = {
  badge: "Direito Cível",
  title:
    "Proteção patrimonial, assessoria contratual e resolução de conflitos civis",
  subtitle:
    "Atuação especializada para garantir a segurança dos seus negócios, recuperar créditos, reparar danos patrimoniais e resolver disputas imobiliárias ou contratuais.",
  whatsappMessage:
    "Ol%C3%A1!%20Vim%20pelo%20site%20e%20gostaria%20de%20uma%20consulta%20sobre%20Direito%20C%C3%ADvel.",
};

export function HeroCivel() {
  return (
    <section id="civel" className="px-6 md:px-12 max-w-7xl mx-auto mb-20">
