const heroData = {
  ...
  title:
    "Apoio jurídico humanizado e focado na proteção do seu patrimônio e dos seus filhos",
  subtitle:
    "Atuação especializada para solução de divórcios, guarda, pensão alimentícia e inventários com discrição, agilidade e firmeza técnica.",
  whatsappMessage:
...
export function HeroFamilia() {
  return (
    <section id="familia" className="px-6 md:px-12 max-w-7xl mx-auto mb-20">
