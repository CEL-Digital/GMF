        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-16 gap-6">
          <div>
            <h2 className="font-news text-3xl md:text-5xl text-white font-semibold mt-6 leading-tight max-w-2xl">
              Advocacia estratégica pautada em{" "}
              <span className="text-zinc-400 italic">
                excelência e combate técnico.
              </span>
            </h2>
          </div>
          <p className="text-zinc-400 text-sm md:text-base max-w-md">
            A GMF Advogados une a tradição do rigor jurídico à dinamicidade da
            advocacia contemporânea, entregando soluções sob medida para cada
            cliente.
          </p>
        </div>
          ...
          <div className="lg:col-span-7 flex flex-col justify-between space-y-8">
            <div className="relative p-8 md:p-10 space-y-6 border-white before:absolute before:inset-y-0 before:left-[2px] before:w-[2px] before:bg-white before:drop-shadow-[0_0_8px_rgba(255,255,255)]">
              ...
              <p className="text-zinc-400 text-sm md:text-base">
                Fundada sob a premissa de que nenhum caso é igual ao outro, a{" "}
                <strong className="text-zinc-200 font-medium">
                  GMF Advogados
                </strong>{" "}
                recusa soluções genéricas. Atuamos de forma incisiva e
                preventiva na defesa dos interesses de trabalhadores, indivíduos
                e empresas.
              </p>

              <p className="text-zinc-400 text-sm md:text-base">
                Nossa prática alia análise profunda de provas, domínio
                jurisprudencial e uma comunicação transparente com o cliente do
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-zinc-800/60">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-500 text-xs font-semibold mt-1">
                      Análise minuciosa de cada prova e detalhe fático.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-500 text-xs font-semibold mt-1">
                      Acompanhamento em linguagem clara e acessível.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 bg-zinc-900/20 border border-zinc-800/50 rounded-3xl p-6 text-center">
              <div>
                <span className="block font-news text-2xl md:text-4xl font-bold text-white">
                  Especialista
                </span>
                <span className="text-[10px] md:text-xs text-zinc-500 uppercase tracking-wider mt-1 block">
                  Direito Trabalhista
                </span>
              </div>
              <div>
            ...
            <div className="h-full bg-zinc-900/60 border border-zinc-800 rounded-3xl p-8 backdrop-blur-md flex flex-col justify-between relative group overflow-hidden">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm mt-4 font-medium">
                  Lidera a bancada jurídica com foco em alta performance
                  técnica, estratégias de negociação e atuação contenciosa firme
                  para a garantia integral dos direitos de seus assessorados.
                </p>
              </div>
            </div>
          </div>
