      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="font-news text-3xl md:text-5xl text-zinc-950 font-semibold mt-6 leading-tight">
            Você está vivenciando alguma destas{" "}
            <span className="text-zinc-600 italic">situações?</span>
          </h2>

          <p className="text-zinc-600 text-sm md:text-base mt-4">
            Muitas vezes, a violação de um direito começa de forma sutil.
            Identificar o cenário correto é o primeiro passo para reaver sua
            tranquilidade.
          </p>
        </div>
          ...
          <div className="lg:col-span-6 flex flex-col gap-2">
            ...
            <div className="flex justify-center bg-white border border-zinc-200/80 rounded-3xl p-8 shadow-sm hover:shadow-md transition-all flex flex-col justify-between min-h-[280px]">
              <div>
                ...
                <p className="text-base text-zinc-600">
                  Cumprir jornadas exaustivas ou assumir tarefas superiores sem
                  a devida contraprestação financeira gera acúmulo de prejuízo
                  mês a mês.
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-center bg-white border border-zinc-200/80 rounded-3xl p-8 shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
              <div>
                ...
                <p className="text-base text-zinc-600">
                  Cobranças não reconhecidas ou nome inserido nos órgãos de
                  proteção ao crédito geram direito à reparação por danos
                  morais.
                </p>
              </div>
            </div>
          ...
          <div className="lg:col-span-6 flex flex-col gap-2">
            ...
            <div className="flex justify-center bg-white border border-zinc-200/80 rounded-3xl p-8 shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
              <div>
                ...
                <p className="text-base text-zinc-600">
                  Decisões administrativas do INSS frequentemente omitem
                  períodos de contribuição ou cálculos benéficos ao segurado.
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-center bg-white border border-zinc-200/80 rounded-3xl p-8 shadow-sm hover:shadow-md transition-all flex flex-col justify-between min-h-[280px]">
              <div>
                ...
                <p className="text-base text-zinc-600">
                  A falta de formalização e estratégia em conflitos familiares
                  pode resultar em perdas patrimoniais expressivas e desgaste
                  emocional.
                </p>
              </div>
            </div>
          ...
          <div className="lg:col-span-12 bg-white border border-zinc-200/80 rounded-3xl p-8 md:p-10 shadow-sm hover:shadow-md transition-all flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="space-y-2 text-center md:text-left">
              ...
              <p className="text-base text-zinc-600 text-left">
                O tempo costuma ser um fator determinante no Direito. <br />{" "}
                Quanto antes seu caso for analisado por um especialista, maiores
                são as chances de preservação dos seus direitos.
              </p>
            </div>
            <div>
              <a
