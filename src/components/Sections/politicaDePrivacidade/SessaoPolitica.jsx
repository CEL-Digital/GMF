          ...
          <main className="lg:col-span-8 space-y-12 text-zinc-700 text-sm">
            <section id="introducao" className="scroll-mt-28 space-y-3">
              ...
              <p className="text-zinc-600">
                Esta Política de Privacidade descreve como a empresa responsável
                por este site coleta, utiliza, armazena e protege as informações
                pessoais dos usuários deste site. Ao continuar navegando, você
                declara estar ciente das práticas aqui descritas.
              </p>
              <p className="text-zinc-600">
                Levamos a sua privacidade a sério e tratamos os seus dados
            ...
            <section id="responsavel" className="scroll-mt-28 space-y-3">
              ...
              <p className="text-zinc-600">
                A empresa responsável por este site atua como controladora dos
                dados pessoais tratados no âmbito deste site, sendo responsável
                por decidir sobre a forma e a finalidade do tratamento.
              </p>
            </section>
            ...
            <section id="coleta" className="scroll-mt-28 space-y-3">
              ...
              <p className="text-zinc-600">
                ...
                preencher nossos formulários de contato, agendar consultas ou
              ...
              <ul className="list-disc pl-5 text-zinc-600">
                ...
                <li>
                  Dados de navegação anônimos (cookies para estatísticas de
                  acesso).
                </li>
              </ul>
            </section>
            ...
            <section id="uso" className="scroll-mt-28 space-y-3">
              ...
              <ul className="list-disc pl-5 text-zinc-600">
                <li>
                  Dar retorno às suas solicitações de orçamento e atendimento;
                </li>
                <li>
                  Prestação de serviços advocatícios e assessoria jurídica;
                </li>
                <li>Cumprimento de obrigações legais ou regulatórias;</li>
                <li>
                  Melhoria contínua da experiência de navegação do nosso site.
                </li>
              </ul>
            </section>
            ...
            <section id="bases-legais" className="scroll-mt-28 space-y-3">
              ...
              <p className="text-zinc-600">
                O tratamento dos seus dados pessoais se apoia nas bases legais
                previstas na LGPD, entre elas:
              </p>
              <ul className="list-disc pl-5 text-zinc-600">
                <li>O seu consentimento, quando solicitado;</li>
                <li>
                  A execução de contrato ou de procedimentos preliminares
                  relacionados a um contrato;
                </li>
                <li>O cumprimento de obrigação legal ou regulatória;</li>
                <li>
                  O legítimo interesse, respeitados os seus direitos e
            ...
            <section id="cookies" className="scroll-mt-28 space-y-3">
              ...
              <p className="text-zinc-600">
                ...
                funcionamento do site, lembrar suas preferências e entender como
                ele é utilizado. Você pode gerenciar ou desativar os cookies nas
                configurações do seu navegador, ciente de que algumas
            ...
            <section id="compartilhamento" className="scroll-mt-28 space-y-3">
              ...
              <p className="text-zinc-600">
                Não vendemos os seus dados pessoais. O compartilhamento ocorre
                apenas quando necessário e limitado às seguintes situações:
              </p>
              <ul className="list-disc pl-5 text-zinc-600">
                <li>
                  Com prestadores de serviços que atuam em nosso nome (como
                  hospedagem, analítica e comunicação), obrigados
                  contratualmente a proteger os dados;
                </li>
                <li>
                  Para cumprimento de obrigação legal ou de determinação de
                  autoridade competente;
                </li>
                <li>
                  Com o seu consentimento, nas demais hipóteses não previstas
                  acima.
                </li>
              </ul>
            </section>
            ...
            <section id="armazenamento" className="scroll-mt-28 space-y-3">
              ...
              <p className="text-zinc-600">
                ...
                perda, alteração ou divulgação indevida. Nenhum sistema é
            ...
            <section id="tempo" className="scroll-mt-28 space-y-3">
              ...
              <p className="text-zinc-600">
                Mantemos os dados pessoais apenas pelo tempo necessário ao
                cumprimento das finalidades para as quais foram coletados, salvo
                quando a retenção por prazo maior for exigida por obrigação
                legal, regulatória ou para o exercício de direitos.
              </p>
            </section>
            ...
            <section id="direitos" className="scroll-mt-28 space-y-3">
              ...
              <p className="text-zinc-600">
                ...
                13.709/2018), você tem o direito de solicitar a qualquer
                momento:
              </p>
              <ul className="list-disc pl-5 text-zinc-600">
            ...
            <section id="exercer-direitos" className="scroll-mt-28 space-y-3">
              ...
              <p className="text-zinc-600">
                ...
                conosco pelos canais de atendimento informados neste site.
            ...
            <section id="menores" className="scroll-mt-28 space-y-3">
              ...
              <p className="text-zinc-600">
                Este site não se destina a menores de idade sem o devido
                consentimento dos responsáveis legais. Caso identifiquemos a
                coleta de dados de um menor sem autorização adequada, adotaremos
                as providências necessárias para eliminá-los.
              </p>
            </section>
            ...
            <section id="alteracoes" className="scroll-mt-28 space-y-3">
              ...
              <p className="text-zinc-600">
                ...
                para refletir mudanças em nossas práticas ou na legislação. A
                versão vigente estará sempre disponível nesta página, com a data
                da última atualização indicada no início do documento.
              </p>
            </section>
            ...
            <section id="contato" className="scroll-mt-28 space-y-3">
              ...
              <p className="text-zinc-600">
                ...
                pelos canais de atendimento informados neste site.
              </p>
            </section>
          </main>
        </div>
