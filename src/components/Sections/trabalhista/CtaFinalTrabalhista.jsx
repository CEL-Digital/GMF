const whatsappMessage = "Ol%C3%A1!%20Vim%20pelo%20site%20e%20gostaria%20de%20uma%20consulta%20sobre%20Direito%20Trabalhista.";
      ...
      <div className="bg-zinc-950 text-white rounded-3xl p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl">
        <div className="max-w-2xl space-y-3 text-center md:text-left">
          ...
          <p className="text-sm text-zinc-400">
            Prazos trabalhistas são rígidos. Envie uma mensagem e obtenha o diagnóstico de seu caso.
          </p>
        </div>
