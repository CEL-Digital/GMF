        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-16 border-b border-zinc-900">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs font-light">
              ...
              <li>
                <Link to="/direito-civel" className="hover:text-white transition-colors">
                  Cível
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/direito-do-consumidor" className="hover:text-white transition-colors">
                  Consumidor
                </Link>
              </li>
              <li>
                <Link to="/direito-criminal" className="hover:text-white transition-colors">
                  Criminal
                </Link>
              </li>
              <li>
